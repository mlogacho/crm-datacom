...
from .views import RoleViewSet, UserViewSet, get_user_permissions, verify_2fa_setup, get_account_managers, generate_and_send_password, generate_backup
...
urlpatterns = [
    ...
    path('backup/', generate_backup, name='generate_backup'),
